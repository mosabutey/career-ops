# Career-Ops LifeSci -- Career Operating System

## Origin

This system began with the excellent open-source work of [santifer](https://santifer.io), who used the original repo to evaluate 740+ job offers, generate 100+ tailored CVs, and land a Head of Applied AI role. This fork keeps that local-first foundation and expands it into a broader career operating system for scientific, clinical, consulting, technical, and multidomain career paths.

The portfolio that goes with this system is also open source: [cv-santiago](https://github.com/santifer/cv-santiago).

**It will work out of the box, but it's designed to be made yours.** If the role packs do not match the user's path, the modes are in the wrong language, or the scoring does not fit their priorities, just ask. You (AI Agent) can edit the user's files. The user says "change the role packs to medical affairs and consulting" and you do it. That is the point.
...
- `{"status": "update-available", "local": "1.0.0", "remote": "1.1.0", "changelog": "..."}` → tell the user:
  > "Career-Ops LifeSci update available (v{local} → v{remote}). Your data (CV, profile, tracker, reports) will NOT be touched. Want me to update?"
...
> - Any deal-breakers? (for example: no heavy travel, no purely sales roles, no low-fit internships, no bench-only jobs)
