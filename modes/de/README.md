...
Die übrigen Modi (`scan`, `batch`, `pdf`, `tracker`, `auto-pipeline`, `contact`, `compare`, `project`, `training`) sind absichtlich nicht in diesem PR dabei. Sie funktionieren weiter über die englischen Originale, weil ihr Inhalt zu großen Teilen aus Tooling, Pfaden und Konfigurationskommandos besteht — diese sollen sprachunabhängig bleiben.
